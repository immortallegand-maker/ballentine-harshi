...
export default function FullScreenPlayer({ onClose }: Props) {
  ...
  const videos = [
    {
      id: 1,
      url: "https://youtube.com/shorts/3JUWvk6Q1TU",
      caption: "She is Dhakkad Girl 👑 or A Princess? 👸",
    },
    {
      id: 2,
      url: "https://youtube.com/shorts/_jxItzdksHY",
      caption: "Meeting you was a coincidence, staying friends was a choice 🧿🤗💖",
    },
  ];
